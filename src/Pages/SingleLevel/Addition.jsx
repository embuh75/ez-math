...
function Addition() {
  ...
  function leaveGameConfirmation(){
      const leaveGame = confirm("Apakah anda yakin ingin meninggalkan laman?")
  ...
  return (
    <main className="gameplay-main">
      ...
      <div className="x-container">
        ...
        className={activeButton != null | activeButton != undefined? "" : "disabled"}>Pertanyaan Selanjutnya</button>
